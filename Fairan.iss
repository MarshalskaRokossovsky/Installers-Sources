...
AppName=Fairan's Vision
AppVersion={#VerDate}
AppVerName=Fairan's Vision
AppCopyright=Файран Линумсол
AppPublisher=Файран Линумсол
...
OutputDir=.\Build
DefaultDirName=\
OutputBaseFilename=Fairan's_Vision
...
ru.ClickNext=С уважением, звёздный скиталец, Файран Линумсол
ru.WelcomeLabel1=Данная программа установит на твой компьютер сборник модификаций Fairan's Vision
ru.WelcomeLabel2=Данный сборник несёт в себе авторское видение игры. Искренне надеюсь, что и тебе эти модификации придутся по вкусу.
...
ru.InstallComplete=Удачи и попутного ветра вам, рейнджер!
ru.InstallFinish=Комплект модификаций {#SetupSetting("AppVerName")} успешно установлен!
ru.Discord=Discord сервер
ru.Universe=Установить комплект модов Fairan's Vision от {#VerDate}
