...
OutputDir=.\Build
DefaultDirName=\
OutputBaseFilename=Kotyanka_{#VerDate}
...
[Components]
Name: Kotyanka; Description: {cm:Kotyanka}; Types: custom; Flags: fixed;
Name: KotyankaPlus; Description: {cm:KotyankaPlus}; Types: custom;

[Files]
Source: KotyankaPlusSourceFiles\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: KotyankaPlus; 
Source: KotyankaSourceFiles\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Kotyanka;
...
ru.ClickNext=Барон фон Кошкинс
ru.WelcomeLabel1=Добро пожаловать, рейнджер!
ru.WelcomeLabel2=Тебя приветствует программа установки сборника Котянка и Котянка Плюс для игры Космические Рейнджеры HD: Революция.%n%nДанные модификации точно придутся по вкусу разным рейнджерам - кому визуальной составляющей, а кому - новыми кораблями, пушками и многим другим.
...
en.KotyankaPlus=Установить комплект модов KotyankaPlus от 01.03.2022
...
ru.KotyankaPlus=Установить комплект модов Kotyanka
ru.Kotyanka=Установить комплект модов KotyankaPlus
