...
OutputDir=.\Build
DefaultDirName=\
OutputBaseFilename=Mods_Pack_{#VerDate}
...
[Components]
Name: Redux; Description: {cm:Redux}; Types: custom; Flags: exclusive;
Name: Original; Description: {cm:Original}; Types: custom; Flags: exclusive;
Name: Community; Description: {cm:Community}; Types: custom; Flags: exclusive;
Name: Reflection; Description: {cm:Reflection}; Types: custom;
Name: Solyanka; Description: {cm:Solyanka}; Types: custom;
Name: Kotyanka; Description: {cm:Kotyanka}; Types: custom;
Name: CommunityMods; Description: {cm:CommunityMods}; Types: custom;
Name: Klisan; Description: {cm:Klisan}; Types: custom;
Name: Fairan; Description: {cm:Fairan}; Types: custom;
Name: Polaria; Description: {cm:Polaria}; Types: custom;
Name: Others; Description: {cm:Others}; Types: custom;
Name: DeleteMods; Description: {cm:DeleteMods}; Types: custom; 
Name: InstallModCFG; Description: {cm:InstallModCFG}; Types: custom;

[Files]
Source: SourceFiles\UniverseRedux\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Redux; 
Source: SourceFiles\UniverseOriginal\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Original;
Source: SourceFiles\UniverseCommunity\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Community;
Source: SourceFiles\Reflection\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Reflection;
Source: SourceFiles\Solyanka\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Solyanka;
Source: SourceFiles\Kotyanka\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Kotyanka;
Source: SourceFiles\CommunityMods\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: CommunityMods;
Source: SourceFiles\KlisanMods\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Klisan;
Source: SourceFiles\FairansVision\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Fairan;
Source: SourceFiles\PolariaMods\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Polaria;
Source: SourceFiles\OtherMods\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Others;
...
en.Original=Установить комплект модов Universe Original от 22.04.2024
en.Community=Установить комплект модов Universe Community от 05.08.2024
en.Redux=Установить комплект модов Universe Redux от 26.07.2024
en.Reflection=Установить комплект модов Reflection от 26.07.2024
en.Solyanka=Установить комплект модов Solyanka от 01.03.2022
en.Kotyanka=Установить комплект модов Kotyanka от 25.07.2024
en.CommunityMods=Установить комплект модов Community Mods от 05.06.2024
en.Klisan=Установить комплект модов Klisan -57-'s Mods от 23.07.2022
en.Fairan=Установить комплект модов Fairan's Vision от 25.06.2024
en.Polaria=Установить комплект модов Polaria Mods от 11.12.2023
en.Others=Установить комплект прочих модов
...
ru.Original=Установить комплект модов Universe Original от 22.04.2024
ru.Community=Установить комплект модов Universe Community от 05.08.2024
ru.Redux=Установить комплект модов Universe Redux от 30.07.2024
ru.Reflection=Установить комплект модов Reflection от 30.07.2024
ru.Solyanka=Установить комплект модов Solyanka от 01.03.2022
ru.Kotyanka=Установить комплект модов Kotyanka от 25.07.2024
ru.CommunityMods=Установить комплект модов Community Mods от 05.06.2024
ru.Klisan=Установить комплект модов Klisan -57-'s Mods от 23.07.2022
ru.Fairan=Установить комплект модов Fairan's Vision от 25.06.2024
ru.Polaria=Установить комплект модов Polaria Mods от 11.12.2023
ru.Others=Установить комплект прочих модов
