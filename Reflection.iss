...
AppName=Reflection
AppVersion=1.5.0{#VerDate} Dipsciplio
AppVerName=Reflection 1.5.0
AppCopyright=Reflection's Team
AppPublisher=Творческое Объединение Мододелов
AppPublisherURL="https://boosty.to/marshalska"

// Directory setup
SourceDir=. 
OutputDir=.\Build
DefaultDirName=\
OutputBaseFilename=Reflection_1.5.0
...
[Languages]
Name: en; MessagesFile: "compiler:Default.isl"; InfoBeforeFile: "Information-Russian.rtf"
...
ru.ClickNext=Команданте спецотряда Земной НСР "Фалькон-1" %n"Маршал" Энатайн
ru.WelcomeLabel1=Добро пожаловать, рейнджер!
ru.WelcomeLabel2=Рад видеть, что ты решил загрузить и установить себе сборник модификаций Reflection для игры Космические Рейнджеры HD: Революция.%n%nДанный материал необходимо установить поверх уже установленного пакета Universe Redux для максимально гладкой работы модификаций.%n%nЗдесь пока можно найти не настолько много различного нового материала, сколько найти в Universe, но удивить такого рейнджера, как ты, думаю, сумеет.%nОсобенно учитывая то, что над сборником модификаций ведётся активнейшая работа, направленная на увеличение сложности и проработанности новых механик.
...
// Russian
ru.GameExist=В указанной директории игра (Файл Rangers.exe, если вы хотите осмотреть модификации) не обнаружена, проверьте правильность пути!
...
ru.Discord=Подержать разработчика (за баги)
ru.Universe=Установить комплект модов Reflection от {#VerDate}
