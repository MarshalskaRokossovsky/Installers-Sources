...
AppName=Reflection Lite
AppVersion=1.4.0{#VerDate} RefMusic
AppVerName=RefMusic Add-On
AppCopyright=Reflection's Team
AppPublisher=Творческое Объединение Мододелов
AppPublisherURL="https://discord.gg/qDdTcsynuy"

// Directory setup
SourceDir=. 
OutputDir=.\Build
DefaultDirName=\
OutputBaseFilename=RefMusic_for_1.4.0
...
[Files]
Source: SourceFilesMusic\*; DestDir: {app}; Flags: ignoreversion createallsubdirs recursesubdirs; Components: Universe; 
...
ru.WelcomeLabel2=В твоём распоряжении находится установщик блока RefMusic, выделенного из остальной сборки по причине колоссального объёма - больше 1.2 Гб новых треков!%n%nМы постарались собрать как можно более близкую к оригинальной игре музыку, ну а насколь хорошо это получилось - судить уже тебе самому.%n%nХорошего прослушивания!
